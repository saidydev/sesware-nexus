...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="p-0 m-0 list-none">
        ...
        <section class="text-white w-full h-auto bg-cover bg-center bg-blue-200" style="background-image: linear-gradient(to right,rgba(175, 111, 238, 0.199),hsla(266, 89%, 11%, 0.944)),url('./images/KANYASI_66.jpg')">
            ...
            <div class="flex flex-col gap-4 mx-4 mt-banner pb-10 lg:flex lg:flex-row lg:mx-banner lg:pl-10 lg:mt-banner lg:pb-14 items-center ">
                <div class="flex flex-col gap-4 lg:w-4/5 text-center" style="margin: 5% auto">
                    <h2 class="text-mobilehead lg:text-headimg font-headimg" data-aos="fade-up" data-aos-duration="3000">Our Products</h2>
        ...
        <section class="px-mob py-top text-md lg:px-banner lg:py-top font-content">
            ...
            <div class="grid grid-cols-1 gap-4 mt-small lg:grid lg:grid-cols-4 lg:gap-6 lg:mt-small">
                <div class="bg-hd flex flex-col gap-2 rounded-sm">
                    <img src="./images/KANYASI_66.jpg">
                    <div class="p-3 flex flex-col gap-2 text-white">
                        <h3>Real estate Management System</h3>
                        <p class="text-slate-300">Build By sesware</p>
                        <a href="">Live Demo &nbsp; &RightArrow;</a>
                    </div>
                </div>
                <div class="bg-hd flex flex-col gap-2 rounded-sm">
        ...
        <section class="px-mob py-top text-md lg:px-banner lg:py-top font-content flex flex-col gap-3">
            <div class="flex flex-col gap-1">
                <h2 class="lg:text-xl text-hd font-headimg">Projects </h2>
                <h2 class="text-2xl lg:text-3xl font-headimg mb-4">All Completed Projects to our Customers</h2>
                <hr class="h-1 w-20 lg:h-1.5 lg:w-20 bg-hd">
            </div>
            <diV>
                <table class="w-full text-left">
                    <tr class="lg:h-10 lg:w-full border-b text-p">
                        <th class="lg:w-year">Year</th>
                        <th class="lg:w-project">Project</th>
                        <th class="lg:w-details">Details</th>
                        <th class="lg:w-link">Link</th>
                    </tr>
                    <tr class="lg:h-14 border-b">
                        <td class="text-slate-500">2022</td>
                        <td>Mwenge Catholic University Website</td>
                        <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, sunt?</td>
                        <td class="text-hd"><a href="https://mwecau.co.tz">mwecau.co.tz</a></td>
                    </tr>
                    <tr class="lg:h-14 border-b">
                        <td class="text-slate-500">2022</td>
                        <td>Mwenge Catholic University Website</td>
                ...
                <div class="flex gap-4 mt-4">
                    <a href="" class="bg-hd p-3 lg:p-2 rounded-sm text-center text-white">
                        <button>Next &RightArrow;</button>
                    </a>
                    <a href="" class="bg-hd p-3 lg:p-2 rounded-sm text-center text-white">
                        <button>Back &LeftArrow;</button>
                    </a>
                </div>
                </table>
